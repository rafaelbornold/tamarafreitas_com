...
const ComponentCursoBlock = (props) => {
        ...
        const fechaEnd = fechas[0].fecha != fechas[fechas.length -1].fecha ? ` - ${String(fechas[fechas.length -1].fecha.getDate()).padStart(2,"0")}/${monthName[fechas[0].fecha.getMonth()]}` : "";
        ...
        <article className="cursos_list-block-content">
            <div className="cursos_list-block-th-wrap">
                ...
                <div className="cursos_list-block-wrapper-button">
                        <Button name="btn-01" width="85%" type="route" text="VER MÁS" link={linkVerMas}/>
                </div>
            </div>
        </article>
